...
<body>
	<div class="wrapper">
		...
		<div class="container">
          ...
          <label class="label" for="check-menu"></label>
            ...
            <a class="menu-item" href="#">Prodacts</a>
            ...
            <a class="menu-item" href="#">Contact</a>
				...
				<nav class="nav">
					...
					<a class="nav-item is-active" href="#">Products</a>
		...
		<main class="main">
			<section class="section section-hero">
				<div class="section-background">
					<div class="section-hero-decore"></div>
					...
					<div class="container">
						<div class="grid">
							...
							<div class="grid-item width-1-1 width-3-5-s">
								...
								<p class="section-subtitle">dummy text of the<br> printing & typesetting </p>
								<a class="button" href="#">
									<span class="icon-check"></span>Sign up now
								</a>
							</div>
						</div>
					</div>	
			...
			<section class="section">
				<div class="container">
					<div class="grid">
						<div class="grid-item width-1-1 width-1-3-l">
			...
			<section class="section">
				<div class="container">
					<div class="grid">
						<div class="grid-item width-1-1 width-1-2-l">
